...
namespace Beast_Chipping.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdCliente,Nome,Telemovel,Email,NIF,Morada,CodigoPostal,DataCriacao")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCliente,Nome,Telemovel,Email,NIF,Morada,CodigoPostal,DataCriacao")] Cliente cliente)
        {
