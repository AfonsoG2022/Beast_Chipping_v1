...
namespace Beast_Chipping.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeCategoria,Ficheiro")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeCategoria,Ficheiro")] Categoria categoria)
        {
            if (id != categoria.Id)
            {
                return NotFound();
