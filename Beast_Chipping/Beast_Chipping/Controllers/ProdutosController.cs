...
namespace Beast_Chipping.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Descricao,Preco,Especificacoes,DataCriacao")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Descricao,Preco,Especificacoes,DataCriacao")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
